					...
					<form action="/Files_manage_system/Admin/BaseInfo/editInfo" method="post">
						...
						<div class="single-row">
							...
							<div class="single-row">
								<label>
									<span>发卡银行：</span>
									<input type="text" name="emp_bank" class="short" value="<?php echo ($emp_bank); ?>">
								</label>
								<label>
									<span>社会保险：</span>
							...
							<div class="single-row">
								<label>
									<span>信用卡号：</span>
									<input type="text" name="emp_card_num" class="short" value="<?php echo ($emp_card_num); ?>">
								</label>
								<label>
									<span>医疗保险：</span>
								...
								<label>
									<span>公积金号：</span>
									<input type="text" name="emp_reseverd_fund" class="short" value="<?php echo ($emp_reseverd_fund); ?>">
								</label>
							</div>
						</div>
					</form>
