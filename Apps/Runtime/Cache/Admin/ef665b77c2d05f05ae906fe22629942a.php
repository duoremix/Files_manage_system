	...
	<section>
		<div class="container">
			...
			<div class="content">
				...
				<div>
					<form action="/Admin/BaseInfo/BaseInfo_save" enctype="multipart/form-data" method="post" id="form_baseInfo">
						<div class="single-row">
							<a id="save" class="btn btn-primary super">保存</a>
							<a id="cancel" class="btn btn-default" href='/Admin/BaseInfo/check'>取消</a>
						</div>
						<div id="emp_photo">
							<input type="file" name="emp_photo">
							<div class="tips">点此上传图片</div>
							<img src="/Public/image/default.png" alt="">
						</div>
						<div class="single-row">
