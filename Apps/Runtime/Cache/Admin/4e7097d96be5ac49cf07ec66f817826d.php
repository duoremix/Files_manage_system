				...
				<div>
					<form action="/Files_manage_system/Admin/Performance/train_save" method="post" id="form_train">
						<div class="single-row">
							...
							<a id="add" class="btn btn-info">添加参训人员</a>
							<a id="delete" class="btn btn-warning">移除参训人员</a>
							<a class="btn btn-default" href="train_check">取消</a>
						</div>
						<div class="single-row">
							<label>
								<span>培训名称：</span>
								<input type="text" name="train_name" class="middle">
							</label>
							<label>
								<span>培训内容：</span>
								<input type="text" name="train_content" class="long">
							</label>
						</div>
						<div class="single-row">
							<label>
								<span>培训单位：</span>
								<input type="text" name="train_unit" class="middle">
							</label>
							<label>
								<span>培训讲师：</span>
								<input type="text" name="train_lecture" class="short">
							</label>
							<label>
								<span>培训地点：</span>
								<input type="text" name="train_place" class="long">
							</label>
						</div>
						<div class="single-row">
							<label>
					...
					<div class="table_scroll short">
						<table class="table table-striped chose" style="display:none">
							<tr>
								<td>档案编号</td>
								<td>姓名</td>
								<td>性别</td>
